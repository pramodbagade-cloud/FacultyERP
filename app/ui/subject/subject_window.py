...
class SubjectWindow:
    ...
    def build_ui(self):
        ...
        title = ctk.CTkLabel(self.parent, text="Subject Management", font=("Segoe UI", 24, "bold") )
        ...
        self.subject_type_combo = ctk.CTkComboBox(
            ...
            state="readonly",
            command=self.on_subject_type_changed
        )
    ...
    def load_courses(self, department_id=None):
        self.course_map.clear()
        if department_id is None:
            courses = CourseService.get_courses()
        else:
            courses = CourseService.get_courses_by_department(
                department_id
            )
        values = []
    ...
    def load_subjects(self):
        ...
        for subject in subjects:
            course=CourseService.get_course(subject.course_id)
            subject_name=(subject.subject_name or "").replace("\r"," ").replace("\n"," ").strip()
        ...
        self.code_entry.insert(0, SubjectService.generate_subject_code())
    ...
    def on_subject_type_changed(self, subject_type):

        self.theory_hours_combo.configure(
            state="readonly"
        )

        self.practical_hours_combo.configure(
            state="readonly"
        )

        self.tutorial_hours_combo.configure(
            state="readonly"
        )
    ...
    def save_subject(self):
        ...
        if success:
            ...
            messagebox.showwarning("Subject", message)
    ...
    def clear_form(self):
        ...
        self.university_subject_code_entry.delete(0, tk.END      )
    ...
    def on_row_selected(self, event):
        ...
        self.code_entry.configure(state="normal")
        self.code_entry.delete(0, tk.END)
        self.code_entry.insert(0, subject.subject_code)
        self.code_entry.configure(state="readonly")
        self.university_subject_code_entry.delete(0, tk.END)
        self.university_subject_code_entry.insert(0, subject.university_subject_code or "")
        ...
        self.name_entry.delete(0, tk.END )
        self.name_entry.insert(0, subject.subject_name)
        ...
        self.short_name_entry.delete(0, tk.END)
        self.short_name_entry.insert(0, subject.subject_short_name)
        ...
        self.description_entry.delete("1.0", tk.END )
        self.description_entry.insert("1.0", subject.description )
        ...
        self.credits_combo.set(str(subject.credits))
        self.subject_type_combo.set(
        ...
        self.theory_hours_combo.set(str(subject.theory_hours))
        self.practical_hours_combo.set(str(subject.practical_hours))
        self.tutorial_hours_combo.set(str(subject.tutorial_hours) )
        ...
        department = DepartmentService.get_department(subject.department_id )
        if department:
        ...
        if course:
            self.course_combo.set(course.course_name )
