...
class FacultyWindow:
    ...
    def build_ui(self):
        ...
        self.employee_code_entry = ctk.CTkEntry(

            form

        )

        self.employee_code_entry.grid(
        ...
        self.designation_combo = ctk.CTkComboBox(
        ...
        self.middle_name_entry = ctk.CTkEntry(
        ...
        self.qualification_combo = ctk.CTkComboBox(
        ...
        self.employment_combo = ctk.CTkComboBox(
    ...
    def load_designations(self):
        ...
        self.designation_combo.configure(

            values=values

        )

        self.designation_combo.set(
    ...
    def load_faculty(self):
        ...
        self.code_entry.insert(
            ...
            FacultyService.generate_faculty_code()
    ...
    def clear_form(self):
        ...
        self.employee_code_entry.delete(
        ...
        if self.designation_combo.cget(
    ...
    def on_row_selected(self, event):
        ...
        self.employee_code_entry.insert(

            0,

            faculty.employee_code or ""
    ...
    def delete_faculty(self):
        ...
        success, message = FacultyService.delete_faculty(
