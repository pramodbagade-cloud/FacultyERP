...
class FacultySubjectAllocationWindow(ctk.CTkToplevel):
    ...
    def create_widgets(self):
        ...
        self.theory_entry = ctk.CTkEntry(
            self.main_frame
        )

        self.theory_entry.insert(
            0,
            "0"
        )

        self.theory_entry.grid(
            row=row + 1,
            column=0,
            padx=10,
            pady=(0, 10),
        ...
        self.practical_entry = ctk.CTkEntry(
            self.main_frame
        )

        self.practical_entry.insert(
            0,
            "0"
        )

        self.practical_entry.grid(
            row=row + 1,
            column=1,
            padx=10,
            pady=(0, 10),
        ...
        self.tutorial_entry = ctk.CTkEntry(
            self.main_frame
        )

        self.tutorial_entry.insert(
            0,
            "0"
        )

        self.tutorial_entry.grid(
            row=row + 1,
            column=0,
            padx=10,
            pady=(0, 10),
        ...
        self.workload_entry.insert(
            0,
            "0"
        )

        self.workload_entry.configure(
            state="disabled"
        )
        ...
        self.class_teacher_var = ctk.BooleanVar(
            value=False
        )
    ...
    def load_divisions(self):
        ...
        academic_year_id = self.academic_year_map.get(
            academic_year_name
        )

        course_id = self.course_map.get(
            course_name
        )

        semester_id = self.semester_map.get(
            semester_name
        )
    ...
    def update_allocation(self):
        print("Update Allocation")

    def delete_allocation(self):
        print("Delete Allocation")
