    ...
    def create(connection: sqlite3.Connection):
        ...
        cursor.execute(
            ...
            (
                ...
                is_engineering_science INTEGER NOT NULL DEFAULT 0,
                hod_name TEXT,
                description TEXT,
                is_active INTEGER NOT NULL DEFAULT 1,
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        ...
        cursor.execute(
            ...
            (
                ...
                joining_department_date TEXT,
                university_approval_number TEXT,
                university_approval_date TEXT,
        ...
        cursor.execute(
            ...
            (
                ...
                tutorial_hours REAL NOT NULL DEFAULT 0,

                workload_hours REAL NOT NULL DEFAULT 0,
